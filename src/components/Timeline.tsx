...
<h4 className="vertical-timeline-element-subtitle">Orange, Rennes, France</h4>
<p>
...
<h4 className="vertical-timeline-element-subtitle">Sorbonne Université, Paris, France</h4>
<p>
